...
(test-begin "ilists/constructors")
...
(test-end "ilists/constructors")

(test-begin "ilists/predicates")
...
(test-end "ilists/predicates")

(test-begin "ilist/cxrs")
(define ab (ipair 'a 'b))
(define cd (ipair 'c 'd))
(define ef (ipair 'e 'f))
(define gh (ipair 'g 'h))
...
(test-end "ilists/selectors")

(test-begin "ilists/misc")
...
(test-end "ilists/misc")

(test-begin "ilists/folds")
...
(test-equal (iq 5 7 9)
            (ifilter-map
              ...
              (iq 1 a 2 b 3 4)
              (iq 4 0 5 y 6 z)))
(test-end "ilists/folds")

(test-begin "ilists/filtering")
...
(test-end "ilists/filtering")

(test-begin "ilists/searching")
...
(test-end "ilists/searching")

(test-begin "ilists/deletion")
...
(test-end "ilists/deletion")

(test-begin "ilists/alists")
...
(test-end "ilists/alists")

(test-begin "ilists/replacers")
(test-equal (ipair 1 3) (replace-icar (ipair 2 3) 1))
(test-equal (ipair 1 3) (replace-icdr (ipair 1 2) 3))
(test-end "ilists/replacers")

(test-begin "ilists/conversion")
